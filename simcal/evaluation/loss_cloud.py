...
class LossCloud(BaseCalibrator):
    ...
    def find_cloud(self, evaluate_point, parameter_vector, target_loss, hypercube_loss, loss_tolerance, initial_epsilon,
        ...
        print(lower_bound)
        print(upper_bound)
        cloud_points += self.search_cube(evaluate_point, lower_bound, upper_bound, parameter_vector, target_loss,
    ...
    def binary_search(self, direction, param_key, evaluate_point, initial_point, target_loss, hypercube_loss,
        ...
        while True:
            ...
            ret = evaluate_point(param_value, stoptime)
            iterations += 1
            if ret < target_loss:
    ...
    def search_cube(self, evaluate_point, lower_bound, upper_bound, center, target_loss,
